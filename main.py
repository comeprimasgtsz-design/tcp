    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @ladybot",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
    
[00FF00]BEM-VINDO AO[FF0000] _ _ _ X ³ _ _ _ _   [00FF00] LADY BOT
...
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]Luanzin [FF0000] fe
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] M E  S I G A   [87CEEB] Instagram: [FF0000]@lady_botff
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ BEM VINDO AO LADY BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000]X³
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@lady_botff
[00FF00]»»————-　★　————-««
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[B][C][FFC0CB]porque quer saber meu meu desenvolvedor?

se tiver alguma dúvida sobre mim, basta perguntar para ele 

o id dele é 168274223
"""
...
[FF0000]All bundles use ID: 914000002"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            basic = """[1E90FF]🤖   C O M A N D O S  B A S I C O S   🤖
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[00FF00]/start       [FFFFFF]começa partida 
[00FF00]/exit        [FFFFFF]sair do grupo
[00FF00]/3           [FFFFFF]chama pro squad de 3
[00FF00]/5           [FFFFFF]chama pro squad de 5
[00FF00]/6           [FFFFFF]chama pro squad de 6
[00FF00]! (team code)   [FFFFFF]entra no squad
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            emotes = """[1E90FF]🎭 COMANDOS DE EMOTE  🎭
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[00FF00]/e [emote]        [FFFFFF]manda o EMOTE para você
[00FF00]/e [uid] [emote]  [FFFFFF]manda o emote para o id
[00FF00]/e list           [FFFFFF]listas dos emotes
[00FF00]/e list names     [FFFFFF]nomes dos emotes
[00FF00]/bunlde     [FFFFFF]nome das roupas
[00FF00]/bundles    [FFFFFF]mudar a roupa
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""

                            await safe_send_message(response.Data.chat_type, emotes, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            

                            evo = """[1E90FF]⚡EMOTES EVOLUTIVOS  ⚡  
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB][00FF00]@evos            [FFFFFF]começa o ciclo de emote
[00FF00]@sevos           [FFFFFF]para de mandar o emote
[00FF00]/evo [num]       [FFFFFF]manda o emote (1-18)
[00FF00]/evo [uid] [num] [FFFFFF]manda o emote pro id desejado
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
"""
...
[00FF00]/multijoin [text] [times]    [FFFFFF]Message spam
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            badge_cmnd = """[1E90FF]🎯   COMANDOS BADGE  🎯
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            ad_cmnd = """[1E90FF]🔧  COMANDOS AVANCADOS  🔧
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[00FF00]/inv [uid]           [FFFFFF]convida para entrar no grupo 
[00FF00]/joinroom [id] [pass] [FFFFFF]entrar em qualquer sala
[00FF00]/lag [team_code]     [FFFFFF]trava o squad
[00FF00]/stop lag            [FFFFFF]para o travamento do squad
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[9400D3]M U I T A[FF0000] FE
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] S O U  A M E L H O R   [87CEEB]TELEGRAM: [FF0000]@LADY BOT
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
